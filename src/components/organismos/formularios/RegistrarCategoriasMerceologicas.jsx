...
export function RegistrarCategoriasMerceologicas({
	onClose,
	dataSelect,
	accion,
}) {
	const { insertarCategoriasMerceologicas, editarCategoriasMerceologicas } =
		useCategoriasMerceologicasStore()
			...
			<div className="sub-contenedor">
				<div className="headers">
					<section>
						<h1>
							{accion == 'Editar'
								? 'Editar merceologicas'
								: 'Registrar nueva merceologicas'}
						</h1>
					</section>
